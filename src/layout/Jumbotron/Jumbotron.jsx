    ...
    return (
        <section className={`Jumbotron`}>
            ...
            <div className="more-info">
                <ButtonLink to="/servicos" className="jumbotronButton" variant="primary">Serviços</ButtonLink>
                <ButtonLink to="#cases" className="jumbotronButton" variant="primary">Cases</ButtonLink>
            </div>
        </section>
    )
}
